...
int64 nChainStartTime = 1487148781;
...
const string strMessageMagic = "Hi Signed Message, sun:\n";
...
{
	return nCoinAge * 0.01 * 33 / (365 * 33 + 8);
}
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TongHuiBi
    bool fStrictPayToScriptHash = true; // Always active in TongHuiBi
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TongHuiBi", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Eva is a girl"; //thb marked
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("3cd31c6cb150380bc7b0c8af6b25da215b804403891b2d654a7432e1607bb8fe"));
...
unsigned char pchMessageStart[4] = { 0xf3, 0xac, 0x2b, 0x91 };
...
static bool fGenerateBitcoins = true; //thb
